 ...
 * actions
 */
export const GET_RANKS = 'rank/GET_FOLLOWINGS_RANKS';
export const GET_RANKS_SUCCESS = 'rank/GET_FOLLOWINGS_RANKS_SUCCESS';
export const GET_RANKS_FAILURE = 'rank/GET_FOLLOWINGS_RANKS_FAILURE';
 ...
 * module saga
 */
export function* followingsRankSaga(): Generator {
